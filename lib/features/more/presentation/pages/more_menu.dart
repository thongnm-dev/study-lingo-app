...
Future<void> showMoreMenu(BuildContext context, AuthUser user) async {
  ...
  switch (selected.action) {
    case MoreMenuAction.profile:
      context.push(RouteNames.profile, extra: user);
    case MoreMenuAction.practice:
      context.push(RouteNames.practice);
    default:
      context.push(RouteNames.moreDestination, extra: selected);
  }
}
