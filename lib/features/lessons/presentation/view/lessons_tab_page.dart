...
/// Lessons tab root. Owns [LanguageCubit]: until a study language is picked it
/// shows the language picker, then the skill picker (grammar / vocabulary /
/// listening-speaking / reading / writing). Tapping a skill pushes its topics.
