...
/// Lessons tab root, styled as an "Overview" dashboard: a promo banner, the
/// study-language picker, and the skill tracks for the selected language.
///
/// Reads the app-root [LanguageCubit] (the learning-session language, shared
/// with the vocabulary deck filter). Picking a language highlights it here and
/// reveals its skill tracks; tapping a skill drills into that skill's topics.
  ...
  Widget build(BuildContext context) {
    ...
    return Material(
      ...
      child: InkWell(
        ...
        onTap: () => context.push(
          RouteNames.topics,
          extra: TopicsPageArgs(language: language, skill: skill),
        ),
        child: Padding(
